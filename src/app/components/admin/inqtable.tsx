...
export  default function InquiryTable(){
    ...
    return  <div className="w-full min-h-screen p-6 bg-white flex flex-col items-center">
      ...
      <table className="border-collapse border border-gray-300 w-full text-gray-900">
        ...
        <tbody>
          {inquiries.length > 0 ? (
            ...
            <tr>
              <td colSpan={6} className="p-4 text-center border border-gray-300 text-gray-500">
                No data available
              </td>
            </tr>
          )}
